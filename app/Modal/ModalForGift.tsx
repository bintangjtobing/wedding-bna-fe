                    ...
                    >
                        <div className="absolute z-50 w-full h-screen">
                            <div className="w-screen lg:w-[768px] mx-auto text-white overflow-hidden bg-[#151515] mt-20 px-10 pb-10 py-6 rounded-xl relative">
                                <button onClick={() => setOpenModalGift(false)} className="fixed z-50 border rounded-full p-2">
                                    <ArrowLeft />
                                </button>
                                <section className="overflow-hidden py-14">
                                    <h1 className="text-2xl font-semibold mb-8">Terima kasih</h1>
                                    <h2 className="text-md font-semibold mb-5">Sudah berniat untuk mengirim hadiah</h2>
                                    <p className="text-sm font-light text-gray-200">
                                        Ada beberapa cara untuk kak [nama dari server] bisa mengirim kami hadiah.
                                    </p>
                                    ...
                                    <h2 className="text-2xl font-semibold mt-8">Transfer dari Luar Negeri?</h2>
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mt-5">
                                        <div>
                                            ...
                                            <div className="flex items-center justify-between mt-5">
                                                <p className="text-2xl font-semibold">bintangjtobing@gmail.com</p>
                                                <ClipboardCopyIcon
                                                    className="h-6 w-6 cursor-pointer"
                                            ...
                                            <p className="text-gray-300 font-light">Atas nama</p>
                                            <p className="text-gray-300 font-light">AYU STEVANI SINAGA</p>
                                        </div>
                                    </div>
                                </section>
                                <Footer />
